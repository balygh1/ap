...
--
-- Host: 127.0.0.1
-- Generation Time: 16 يناير 2025 الساعة 17:18
...
CREATE TABLE `destinations` (
  ...
  `destinationsImage` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- إرجاع أو استيراد بيانات الجدول `destinations`
--

INSERT INTO `destinations` (`DestinationID`, `DestinationName`, `Description`, `Location`, `destinationsImage`) VALUES
(1, 'بليغ', '', '', '2024-12-29 at 09-24-53.png'),
(2, 'ييي', '', '', 'vv.png');
...
CREATE TABLE `hotels` (
  ...
  `DestinationID` int(255) NOT NULL,
...
--
ALTER TABLE `destinations`
  MODIFY `DestinationID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
